...
User.create!(id:11,email: 'mverapino@gmail.com', password:'alejandro5', admin: true, encrypted_password: '$2a$10$2K37CPgC5zKCdTDzFwbVDOBXdNt2wAgIWVVOKBJX219Giivq0jSqm', name: 'Mauricio Vera') #.confirm!
