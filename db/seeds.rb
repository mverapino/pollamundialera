...
Prediction.create!(question_type:1 , question:'¿Quién será el cuarto?', points:3)
...
Prediction.create!(question_type:1 , question:'¿Quién será el primer mejor tercer equipo?', points:3)
Prediction.create!(question_type:1 , question:'¿Quién será el segundo mejor tercer equipo?', points:3)
